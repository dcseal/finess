...
/*
// Same as above, but this one only returns flux values, and not the RHS.
void ConstructLFL( StateVars& Qnew, 
    dTensorBC3& F, dTensorBC3& G, dTensorBC3& smax )
{
...
const int mbc_small      = 3;
    ...
    {
        // Save the time-integrated values:
        for( int m=1; m<=meqn; m++ )
        {
