        ...
        dTensorBC3& Lstar, dTensorBC3& smax)
{
    ...
    struct ptr_dTensorBC3{
        dTensorBC3 *p;
        ptr_dTensorBC3(dTensorBC3 *p_in){
            this->p = p_in;
        }
        ~ptr_dTensorBC3(){
            if(this->p != NULL)
    ...
    ptr_dTensorBC3 local_pFhat(NULL), local_pGhat(NULL);
    if(pFhat == NULL){
        local_pFhat.p = new dTensorBC3(mx+1, my, meqn, mbc);
        pFhat = local_pFhat.p;
    }
    if(pGhat == NULL){
        local_pGhat.p = new dTensorBC3(mx, my+1, meqn, mbc);
        pGhat = local_pGhat.p;
    }
    dTensorBC3& Fhat = *pFhat;
    dTensorBC3& Ghat = *pGhat;
