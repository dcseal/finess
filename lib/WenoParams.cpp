...
void WENOParams::init(IniDocument& ini_doc){
    ...
    // Strings describing the available parameters
    ...
    // Check if user wants to replace the default values
    //
    // TODO - is there an alternative to this that doesn't use c++11 so I can
    // compile this on my computer?  (-DS).
