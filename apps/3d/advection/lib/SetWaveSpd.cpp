        ...
        double& s1,double& s2)
{
    ...
    double un_left  = nvec.get(1)*Auxl.get(1) + nvec.get(2)*Auxl.get(2) + nvec.get(3)*Auxl.get(3);
    double un_right = nvec.get(1)*Auxr.get(1) + nvec.get(2)*Auxr.get(2) + nvec.get(3)*Auxr.get(3);
