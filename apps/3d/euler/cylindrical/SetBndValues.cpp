...
#pragma omp parallel for
    ...
    {
 	q.set(i, j, k, 1,  q.get(i, j, 2*mz+1 - k, 1));
	q.set(i, j, k, 2,  q.get(i, j, 2*mz+1 - k, 2));
	q.set(i, j, k, 3,  q.get(i, j, 2*mz+1 - k, 3));
	q.set(i, j, k, 4, -q.get(i, j, 2*mz+1 - k, 4));
	q.set(i, j, k, 5,  q.get(i, j, 2*mz+1 - k, 5));
    }
    // ***********************************************
}
