        ...
        dTensorBC4& fHat, dTensorBC4& gHat, dTensorBC4& hHat)
{
    ...
    double rho,u1,u2,u3,energy, B1, B2, B3, plow,phigh,ffsum,ftmp;
    ...
    for (int i=1; i<=mx+1; i++)
        ...
        //            double the = thex.get(i, j, k);
                    double the = tttt;
                    ftmp = the* (fHat.get(i,j,k,m)-fLF.get(i,j,k,m))+fLF.get(i,j,k,m);
    ...
    //                double the = they.get(i, j, k);
                    double the = tttt;
                    ftmp = the*(gHat.get(i,j,k,m)-gLF.get(i,j,k,m))+gLF.get(i,j,k,m);
    ...
    for (int i=1; i<=mx; i++)
      ...
      //              double the = thez.get(i, j, k);
                    double the = tttt;	    
                    ftmp = the * (hHat.get(i,j,k,m)-hLF.get(i,j,k,m))+hLF.get(i,j,k,m);
