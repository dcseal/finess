        ...
        for (int j=1; j<=(my); j++)
            for (int k=1; k<=(mz); k++)
            {
                ...
                for(int m = 1; m <= maux; ++m){
                    double tmp = 2.0*aux.get(i+1, j, k, m) - aux.get(i+2, j, k, m);
                    aux.set(i, j, k, m, tmp);
                }
            }
    // ***********************************************
    ...
    for (int i=(1-mbc); i<=(mx+mbc); i++)
        for (int j=0; j >= 1-mbc; j--)    
            for (int k=1; k<=(mz); k++)
            {
                ...
                for(int m = 1; m <= maux; ++m){
                    double tmp = 2.0*aux.get(i, j + 1, k, m) - aux.get(i, j + 2, k, m);
                    aux.set(i, j, k, m, tmp);
                }
            }
    // ***********************************************
    ...
    for (int i=(1-mbc); i<=(mx+mbc); i++)
        for (int j=(1-mbc); j<=(my+mbc); j++)    
            for (int k=0; k >= 1-mbc; k--)
            {
                ...
                for(int m = 1; m <= maux; ++m){
                    double tmp = 2.0*aux.get(i, j, k + 1, m) - aux.get(i, j, k + 2, m);
                    aux.set(i, j, k, m, tmp);
                }
            }
    // ***********************************************
