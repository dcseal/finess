...
// This routine is identical to the one above, but this one also returns  the
// flux interface values, that can be limited in the future
// 
void ConstructLxWL(
        const dTensorBC2& aux,
        const dTensorBC2& q,
