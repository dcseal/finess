...
//      double y = xpts.get(i,2);
        ...
        const double elc_charge_dens = -rho_e/mass_ratio;
        ...
        source.set(i,_M1_e ,   ( elc_charge_dens*E1 + (J2_e*B3 - J3_e*B2) ) / larmor_radius );
        source.set(i,_M2_e ,   ( elc_charge_dens*E2 + (J3_e*B1 - J1_e*B3) ) / larmor_radius );
        source.set(i,_M3_e ,   ( elc_charge_dens*E3 + (J1_e*B2 - J2_e*B1) ) / larmor_radius );
        source.set(i,_N_e  ,   ( J1_e*E1 + J2_e*E2 + J3_e*E3              ) / larmor_radius );
