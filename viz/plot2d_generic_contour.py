"""
The purpose of this routine is to allow access to a generic (2D) contour plotting
...
$> python $FINESS/viz/plot2d_generic_contour.py
...
from finess.viz.dim2 \
  import ask_which_component_and_which_frame_and_plot_contour

ask_which_component_and_which_frame_and_plot_contour(args.parameters_ini_filename)
