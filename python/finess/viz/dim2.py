...
def ask_which_component_and_which_frame_and_plot(parameters_ini_filename, plotting_method, **kwargs):
    ...
    draw_ith_frame = \
        lambda fig, i: \
           draw_ith_frame_jth_component( \
             ...
             plotting_method_on_Axes3DSubplot = plotting_method,
             **kwargs)
...
def ask_which_component_and_which_frame_and_plot_wireframe(parameters_ini_filename):
    ...
    from mpl_toolkits.mplot3d import Axes3D
    ask_which_component_and_which_frame_and_plot(parameters_ini_filename, Axes3D.plot_wireframe,
                                                 projection="3d")
